...
void testApp::setup(){
	...
	imagePath = "nature.jpg"; // there's also a hello.bmp to test 1 channel
...
void testApp::edgeDetect1Channel() {
...
void testApp::edgeDetect3Channel() {
...
int testApp::setPixel(unsigned char* px, int startPixel, int above, int center, int below, const int matrix[3][3]) {
    return (
